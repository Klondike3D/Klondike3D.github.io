...
const BlogsContainer = ({ data }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto mt-10 px-8 text-black">
      ...
      <div className="w-auto p-8 m-4 h-72 sm:h-96 xs:h-96 xxs:h-96 mt-10 bg-gradient-to-r from-seccolor to-maincolor rounded-xl flex flex-col items-center justify-center">
        ...
        <div className="text-black hover:text-white mt-10 flex flex-col items-center justify-center">
          ...
          <a
            href="#"
            className="mt-4 transition-all duration-500ms ease-in-out hover:ease-in-out inline-flex justify-center items-center py-2.5 px-5 text-base font-medium text-center text-black hover:text-white rounded-lg border border-main  hover:bg-main"
          >
            Join The List
          </a>
        </div>
